export const projects = [
  ...
  },
  {
    ...
    description: [
      ...
      "Developed in collaboration with a regional Swedish water utility company experiencing water scarcity, this project reframes high school students not just as learners, but as vital catalysts for regional ecological resilience. The challenge required designing an engaging pedagogical model that successfully transforms passive students into proactive agents of change within their own households and broader communities",
      "The framework relies on three core pillars: child-led communication to empower youth to own the environmental narrative and educate their families, gamification to transform water-saving practices into an interactive and collaborative learning experience, and nudge theory to embed behavioral cues in daily routines. This pedagogical approach was prototyped and tested through two pilot workshops involving 46 local high school students in Kalmar (Sweden). A post-workshop survey revealed promising outcomes: 90% of the participants found it to be empowering, informative, and inspiring, while 53% discussed water-related topics in their households.",
    ],
    images: [
  ...
  },
  {
    ...
    images: [
      ...
      "https://res.cloudinary.com/dpks1z6nw/image/upload/v1783422509/WastesNoMore_Workshop.png",
    ],
  },
  {
    id: 4,
